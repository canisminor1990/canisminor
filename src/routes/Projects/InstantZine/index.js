...
export const FileUtils = {
  video: 'https://oss.canisminor.cc/instant-zine.mp4',
  videoCover: 'https://oss.canisminor.cc/instant-zine.png',
  pages: book => {
    let pages = [];
    for (let i = 2; i <= 12; i++) {
      pages.push(`https://oss.canisminor.cc/zine-${book}-${i}.png`);
    }
    return pages;
  },
  cover: book => `https://oss.canisminor.cc/zine-${book}-cover.png`,
  coverLite: book => `https://oss.canisminor.cc/zine-${book}-cover-lite.png`,
  shadow: 'https://oss.canisminor.cc/zine-shadow.png',
};
